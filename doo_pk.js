...
function launchBattle(fpin) {
    console.log("发起挑战");
    console.log("被动挑战链接：https://game-cdn.moxigame.cn/ClickEliminate/IntegralPK_jd/thirdapp/index.html?lkEPin="+$.pin+"&token="+$.token+"&returnurl=https://prodev.m.jd.com/mall/active/45njQg88Vym1s2EGp9aV6cPvqecw/index.html?fxsource=dx&friendPin="+fpin);
    return new Promise((resolve) => {
        let options = {
